...
public class FiniteStateMachineTest{
    ...
    private static Stream<Arguments> provideTestCases() {
        return Stream.of(
                Arguments.of("F", FiniteStateMachine.State.S_0),
                Arguments.of("TF", FiniteStateMachine.State.S_0),
                Arguments.of("TEF", FiniteStateMachine.State.S_0),
                Arguments.of("TESF", FiniteStateMachine.State.S_0),
                ...
                Arguments.of("TES T", FiniteStateMachine.State.S_1),
